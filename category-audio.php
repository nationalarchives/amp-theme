...
get_header(); ?>
	...
	<ul id="feature" class="pics">  <!-- feature -->
		  ...
		  <?php $my_query = new WP_Query('cat=856&posts_per_page=9'); ?>
...
<?php while ($my_query->have_posts()) : $my_query->the_post(); ?>
  ...
  <a href="#" title="next" id="next"><img src="<?php bloginfo('template_directory'); ?>/images/next.png"  /></a>
	  ...
	  <?php $my_query = new WP_Query('cat=-857,167&posts_per_page=4'); ?>
<?php $i = 0 ; ?>
<?php while ($my_query->have_posts()) : $my_query->the_post(); ?>
...
<li  class="<?php echo $extra_class; ?>">
               ...
               <?php endwhile; ?>
               <li class="catLink"><a href="<?php bloginfo( 'url' ); ?>/index.php/category/family-history-audio/" rel="bookmark">View all family history audio</a></li>
	  ...
	  <?php $my_query = new WP_Query('cat=-857,165&posts_per_page=4'); ?>
...
<li  class="<?php echo $extra_class; ?>">
               ...
               <?php endwhile; ?>
               <li class="catLink"><a href="<?php bloginfo( 'url' ); ?>/index.php/category/military-history-audio/" rel="bookmark">View all military history audio</a></li>

        </ul>
        
         <ul id="social-history">
      
	  <?php $my_query = new WP_Query('cat=-857,166&posts_per_page=4'); ?>
...
<li  class="<?php echo $extra_class; ?>">
               ...
               <?php endwhile; ?>
               <li class="catLink"><a href="<?php bloginfo( 'url' ); ?>/index.php/category/social-history-audio/" rel="bookmark">View all social history audio</a></li>

        </ul>
        <ul id="political-history">
      
	  <?php $my_query = new WP_Query('cat=-857,867&posts_per_page=4'); ?>
...
<li  class="<?php echo $extra_class; ?>">
               ...
               <h3><a href="<?php the_permalink() ?>" rel="bookmark" title="Read <?php the_title(); ?>"><?php the_title(); ?></a></h3>
                <p><?php the_time('j F Y') ?></p>
                   ...
                   <?php } ?>
               <?php endwhile; ?>
               <li class="catLink"><a href="<?php bloginfo( 'url' ); ?>/index.php/category/political-history-audio/" rel="bookmark">View all political history audio</a></li>

        </ul>
        <ul id="law-and-order">
      
	  <?php $my_query = new WP_Query('cat=-857,866&posts_per_page=4'); ?>
...
<li  class="<?php echo $extra_class; ?>">
               ...
               <h3><a href="<?php the_permalink() ?>" rel="bookmark" title="Read <?php the_title(); ?>"><?php the_title(); ?></a></h3>
                <p><?php the_time('j F Y') ?></p>
                   ...
                   <?php } ?>
               <?php endwhile; ?>
               <li class="catLink"><a href="<?php bloginfo( 'url' ); ?>/index.php/category/law-and-order-audio/" rel="bookmark">View all law and order audio</a></li>

        </ul>
        <ul id="archivists-and-archives">
      
	  <?php $my_query = new WP_Query('cat=-857,868&posts_per_page=4'); ?>
...
<li  class="<?php echo $extra_class; ?>">
               ...
               <h3><a href="<?php the_permalink() ?>" rel="bookmark" title="Read <?php the_title(); ?>"><?php the_title(); ?></a></h3>
                <p><?php the_time('j F Y') ?></p>
                   ...
                   <?php } ?>
               <?php endwhile; ?>
               <li class="catLink"><a href="<?php bloginfo( 'url' ); ?>/index.php/category/archives-and-archivists-audio/" rel="bookmark">View all archivists and archives audio</a></li>

        </ul>
        <ul id="international">
      
	  <?php $my_query = new WP_Query('cat=-857,869&posts_per_page=4'); ?>
...
<li  class="<?php echo $extra_class; ?>">
               ...
               <h3><a href="<?php the_permalink() ?>" rel="bookmark" title="Read <?php the_title(); ?>"><?php the_title(); ?></a></h3>
                <p><?php the_time('j F Y') ?></p>
                   ...
                   <?php } ?>
               <?php endwhile; ?>
               <li class="catLink"><a href="<?php bloginfo( 'url' ); ?>/index.php/category/international-audio/" rel="bookmark">View all international audio</a></li>
    ...
    <h2>Latest audio</h2>
    <ul>
					  <?php query_posts( 'cat=856&posts_per_page=3'); ?>
